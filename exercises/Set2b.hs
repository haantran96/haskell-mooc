...
smallestDivisor k = smallestDivisor' 2 k
smallestDivisor' :: Integer -> Integer -> Integer
smallestDivisor' t k
    | (mod k t == 0) || (t==k) = t
    | otherwise = smallestDivisor'(t+1)(k)
...
biggestPrimeAtMost x = biggestPrimeAtMost' x x
biggestPrimeAtMost' :: Integer -> Integer -> Integer
biggestPrimeAtMost' i x 
    | i <= 0 = x
    | isPrime(i)==True = i
    | otherwise= biggestPrimeAtMost'(i-1)(x)
